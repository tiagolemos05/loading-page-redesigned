...
const TestimonialCard = ({ quote, name, company, avatar, type }) => {
  ...
  const padding = isLargeCard ? "p-5 md:p-6" : "p-5 md:p-[30px]"
  ...
  if (type === "large-teal") {
    ...
    quoteClasses += " text-primary-foreground text-xl md:text-2xl font-medium leading-7 md:leading-8"
    nameClasses += " text-primary-foreground text-base font-normal leading-6"
    companyClasses += " text-primary-foreground/60 text-base font-normal leading-6"
    cardHeight = "min-h-[350px] md:h-[502px]"
    backgroundElements = (
      <div
    ...
    quoteClasses += " text-foreground text-xl md:text-2xl font-medium leading-7 md:leading-8"
    ...
    quoteClasses += " text-foreground/80 text-base md:text-[17px] font-normal leading-6"
    nameClasses += " text-foreground text-sm font-normal leading-[22px]"
    companyClasses += " text-muted-foreground text-sm font-normal leading-[22px]"
    cardHeight = "min-h-[200px] md:h-[244px]"
  }
