...
const OneClickIntegrationsIllustration: React.FC<OneClickIntegrationsIllustrationProps> = ({ className = "" }) => {
  ...
  const N8nLogo = (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="var(--oci-primary-color)" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg">
  ...
  const OpenAILogo = (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="var(--oci-primary-color)" xmlns="http://www.w3.org/2000/svg">
  ...
  const gridItems = Array(40)
    ...
    .map((_, i) => {
      ...
      if (row === 0 && col === 3) {
        item.logoSvg = N8nLogo
        item.isGradientBg = true
      } else if (row === 1 && col === 5) {
        item.logoSvg = OpenAILogo
        item.isGradientBg = true
      } else if (row === 2 && col === 3) {
        item.logoSvg = SalesforceLogo
        item.isGradientBg = true
      } else if (row === 2 && col === 7) {
